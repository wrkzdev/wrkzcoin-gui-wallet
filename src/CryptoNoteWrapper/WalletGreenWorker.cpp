...
// Get seed
bool WalletGreenWorker::isDeterministic() const {
  AccountKeys accountKeys = getAccountKeys(0); 
  Crypto::SecretKey second;
  keccak((uint8_t *)&accountKeys.spendKeys.secretKey, sizeof(Crypto::SecretKey), (uint8_t *)&second, sizeof(Crypto::SecretKey));
  sc_reduce32((uint8_t *)&second);
  bool keys_deterministic = memcmp(second.data,accountKeys.viewKeys.secretKey.data, sizeof(Crypto::SecretKey)) == 0;
